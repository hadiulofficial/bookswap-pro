    ...
    try {
      ...
      if (error) {
        if (error.message.includes("Unsupported phone provider") || error.message.includes("SMS")) {
          throw new Error(
            "SMS service is not available for Malaysian numbers on the free tier. Please use Google sign-in or contact support.",
          )
        }
        throw error
      }
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="bg-yellow-50 border border-yellow-200 rounded-md p-3">
                            <p className="text-xs text-yellow-800">
                              ...
                              tier. We recommend using Google sign-in for the best experience.
                            </p>
                          </div>
                        </div>
                        <Button
